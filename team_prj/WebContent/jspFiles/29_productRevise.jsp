...
<div class = "container">
	...
	<div class = "right_bar">
		<div><h1 style= "font-weight: bold;">상품관리</h1></div>
		...
		<div class = "button_div">
			<input type = "button" class = "btn btn-primary" value = "수정" style="width:80px;height:40px; font-weight:bold;">
			<a href = "29_productRevise.jsp"><input type = "button" class = "btn btn-default" value = "삭제" style = "background-color: #dfdfdf" id="product_del"></a>
